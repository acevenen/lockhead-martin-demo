...
from roryd import brief as brief_mod
from roryd import intents
from roryd.ledger import Entry, Ledger, LedgerError
...
def test_route_tolerates_transcription_errors_of_the_wake_word():
    # Whisper mishears "Rory" constantly; the assistant must not feel broken
    # because of it.
    for spelling in ["rory", "jarvi", "travis", "charvis"]:
...
def test_normalize_strips_wake_word_and_filler():
    ...
    assert intents.normalize("rory brief me") == "brief me"
