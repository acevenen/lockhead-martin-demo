...
```
open jarvis/index.html          # double-click works
```
...
```
python3 -m http.server 8000     # then open /jarvis/index.html
```
...
- **Wake word** — say “Jarvis”, wait for `COMMAND?`, then speak. Or say it
  in one breath: “Jarvis, brief me.”
