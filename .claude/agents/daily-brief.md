---
name: daily-brief
description: The briefing officer. Use at the start of a session to compile what changed since the owner's last visit, and at the end to write the brief into jarvis/state.json.
---
